...
---------------------- INPUT FILES ---------------------------------------------
"./IEA-15-240-RWT-Monopile_ElastoDyn.T1.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"./IEA-15-240-RWT-Monopile_ServoDyn.T1.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
